  ...
  en: {
    ...
    logsPage: {
      ...
      table: {
        ...
        emptySubtitle:
          "We only keep logs from the last 14 days. Try different filters.",
        prodShort: "Prod",
    ...
    webhooksPage: {
      ...
      events: {
        ...
        'auth.user.blocked': "User Blocked",
        'auth.user.activated': "User Activated",
        'auth.user.updated': "User Updated",
        'aml.user.verified': "User Verified (AML)",
        'aml.user.denied': "User Denied (AML)",
        'identity.user.verification_passed': "Identity Verification Passed",
        'identity.user.verification_failed': "Identity Verification Failed",
        'payments.transfer.accepted': "Transfer Accepted (Payments)",
        'payments.payment.accepted': "Payment Accepted (Payments)",
        'connect.account.created': "Account Created (Connect)",
        'connect.transfer.accepted': "Transfer Accepted (Connect)",
        'contacts.contact.created': "Contact Created",
        'contacts.contact.deleted': "Contact Deleted",
        'contacts.contact.updated': "Contact Updated",
        'discounts.coupon.used': "Coupon Used",
        'tx.international_transfer.accepted': "International Payout Accepted",
        'tx.international_transfer.cancelled': "International Payout Cancelled",
        'alaiza.chat.human_support': "Human Support Requested",
        'alaiza.finance.score_updated': "Finance Score Updated",
      },
  ...
  es: {
    ...
    webhooksPage: {
      ...
      events: {
        ...
        'auth.user.blocked': "Usuario Bloqueado",
        'auth.user.activated': "Usuario Activado",
        'auth.user.updated': "Usuario Actualizado",
        'aml.user.verified': "Usuario Verificado (AML)",
        'aml.user.denied': "Usuario Denegado (AML)",
        'identity.user.verification_passed': "Verificación de Identidad Aprobada",
        'identity.user.verification_failed': "Verificación de Identidad Fallida",
        'payments.transfer.accepted': "Transferencia Aceptada (Pagos)",
        'payments.payment.accepted': "Pago Aceptado (Pagos)",
        'connect.account.created': "Cuenta Creada (Connect)",
        'connect.transfer.accepted': "Transferencia Aceptada (Connect)",
        'contacts.contact.created': "Contacto Creado",
        'contacts.contact.deleted': "Contacto Eliminado",
        'contacts.contact.updated': "Contacto Actualizado",
        'discounts.coupon.used': "Cupón Utilizado",
        'tx.international_transfer.accepted': "Pago Internacional Aceptado",
        'tx.international_transfer.cancelled': "Pago Internacional Cancelado",
        'alaiza.chat.human_support': "Soporte Humano Requerido",
        'alaiza.finance.score_updated': "Puntaje Financiero Actualizado",
      },
      lockedUntilOnboarding:
