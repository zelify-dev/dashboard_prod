export const cardsTranslations = {
  es: {
    configurator: {
      breadcrumb: "Tarjetas",
      designPageTitle: "Diseño",
      designPageDesc:
        "Define el aspecto de la tarjeta (colores, límites, red) y la marca (logos y paleta) de tu programa.",
      ...
      rightPanelAppearanceTitle: "Apariencia del plástico",
      rightPanelAppearanceDesc:
        "Red, color o degradado y acabado. Los cambios se ven al instante en la vista previa del SDK.",
      rightPanelBrandingTitle: "Marca en la app",
      rightPanelBrandingDesc:
        "Logo y color de acento en la interfaz del titular. Al abrir la página se cargan los valores del branding de tu organización.",
      configPanel: {
      ...
      preview: {
        title: "Vista Previa",
        sdkCardholderCaption: "Titular",
        sdkShowPanAria: "Mostrar número de tarjeta",
        sdkHidePanAria: "Ocultar número de tarjeta",
    ...
    cardUsers: {
      pageTitle: "Usuarios",
      title: "Usuarios",
      desc: "Titulares y usuarios vinculados a tarjetas. Selecciona una fila para ver el detalle.",
      table: {
        name: "Nombre",
        email: "E-mail",
        identification: "Identificación",
        status: "Estado",
        noData: "No hay usuarios para mostrar",
      },
      copyId: "Copiar ID",
      copied: "Copiado",
      detail: {
        subtitle: "Consulta todos los datos de este usuario.",
    ...
    issuedCards: {
      pageTitle: "Tarjetas emitidas",
      title: "Tarjetas emitidas",
      desc: "Consulta las tarjetas emitidas en tu organización, con datos del titular y su estado operativo.",
      table: {
        card: "Tarjeta",
        user: "Usuario",
        identification: "Identificación",
        affinityGroup: "Grupo de Afinidad",
        createdAt: "Alta",
        activation: "Activación",
        status: "Estado",
        noData: "No hay tarjetas emitidas",
      },
      activationNone: "Sin datos",
      cardStatus: {
        enabled: "Habilitada",
  ...
  en: {
    configurator: {
      breadcrumb: "Cards",
      designPageTitle: "Design",
      designPageDesc:
        "Customize the card look (colors, limits, network) and your program branding (logos and palette).",
      ...
      rightPanelAppearanceTitle: "Card appearance",
      rightPanelAppearanceDesc:
        "Network, solid or gradient color, and finish. Changes show live in the SDK preview.",
      rightPanelBrandingTitle: "In-app branding",
      rightPanelBrandingDesc:
        "Logo and accent color in the cardholder UI. Values load from your organization branding when you open this page.",
      configPanel: {
      ...
      preview: {
        title: "Preview",
        sdkCardholderCaption: "Cardholder",
        sdkShowPanAria: "Show card number",
        sdkHidePanAria: "Hide card number",
    ...
    cardUsers: {
      pageTitle: "Users",
      title: "Users",
      desc: "Cardholders and users linked to cards. Select a row to view details.",
      table: {
        name: "Name",
        email: "E-mail",
      ...
      copied: "Copied",
      detail: {
        subtitle: "Review all data for this user.",
        editUser: "Edit user",
    ...
    issuedCards: {
      pageTitle: "Issued cards",
      title: "Issued cards",
      desc: "View cards issued to your organization, holder details, and operational status.",
      table: {
        card: "Card",
        user: "User",
        identification: "Identification",
        ...
        status: "Status",
        noData: "No issued cards",
      },
      activationNone: "No data",
      cardStatus: {
        enabled: "Enabled",
        disabled: "Disabled",
      },
    ...
    issuing: {
      ...
      editor: {
        ...
        groupNetworkColor: "Network & color",
        groupFinish: "Finish",
        cancelButton: "Cancel",
