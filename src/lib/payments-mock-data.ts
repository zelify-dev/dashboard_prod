...
export const INITIAL_TRANSFERS_MOCK: TransferItem[] = [
  ...
  },
  {
    ...
    userEmail: "carlos.rodriguez@empresa.com",
    userId: "usr-3",
    sourceAccount: "012180015489201948",
    sourceBank: "STP",
  ...
  },
  {
    ...
    userEmail: "sofia.lopez@empresa.com",
    userId: "usr-5",
    sourceAccount: "012180019284719283",
    sourceBank: "BBVA México",
...
export const INITIAL_DISBURSEMENTS_MOCK: DisbursementItem[] = [
  {
    ...
    createdByEmail: "juan.perez@empresa.com",
    beneficiaries: [
      {
        id: "b-1",
  ...
  },
  {
    ...
    createdByEmail: "maria.garcia@empresa.com",
    beneficiaries: [
      {
        id: "b-3",
  ...
  },
  {
    ...
    createdByEmail: "carlos.rodriguez@empresa.com",
    beneficiaries: [
      {
        id: "b-5",
  ...
  },
  {
    ...
    createdByEmail: "sofia.lopez@empresa.com",
    beneficiaries: [
      {
        id: "b-7",
        name: "Pedro Ramírez",
